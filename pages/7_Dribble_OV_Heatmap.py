...
# df[(df['player']=='Thato Khiba') & (df['type'].isin(['Carry','Dribble'])) & (df['obv_total_net']==0.16970979)]
...
data_doku = df[(df['player'] == selected_player) & (df['type'].isin(['Dribble', 'Carry']))]
