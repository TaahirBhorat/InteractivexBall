...
def plot_dribbles_on_pitch(data):
    ...
    dribbles = data[(data['type'] == 'Carry') & (data['dribble_outcome'] != 'Incomplete')]
    ...
    zone_dribbles = dribbles[(dribbles['carry_end_x'] >= max_dribbles_zone[0]) & (dribbles['carry_end_x'] < max_dribbles_zone[0] + grid_size*3) &
                             (dribbles['carry_end_y'] >= max_dribbles_zone[1]) & (dribbles['carry_end_y'] < max_dribbles_zone[1] + grid_size*3)]
    ...
    rect = Rectangle((max_dribbles_zone[0], max_dribbles_zone[1]), grid_size*3, grid_size*3, linewidth=1, edgecolor='r', facecolor='none')
    ax.add_patch(rect)
